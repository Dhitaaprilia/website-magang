...
<body>
	...
	<table align="center">
		<tr>
			<td>
				<img style="height: 250px; width: 310px; margin-right: 0px; margin-bottom: 10px;" src="login.png">
				<img style="height: 230px; width: 240px; margin-right: 100px; margin-bottom: 10px;" src="kemnaker.png">
			...
			<td>
				<div class="kotakLogin">
					...
					<form method="post" class="form" action="aksilogin.php">
						...
						<!--forgot password-->
						<a href="lupasandi.php" class="forgotPass"> Lupa kata sandi</a>
