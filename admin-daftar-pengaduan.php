    ...
    <h2 style="padding-top: 90px; padding-left: 80px; font-size: 18pt;"> Daftar Pengaduan Perselisihan Hubungan Industrial (PHI)</h2>
      ...
      <form class="d-flex" role="search">
                 <div class="mb-3" style="margin-left: 65px;">
                    ...
                    <input type="text" name="search" class="form-control me-2" type="search" placeholder="Search" aria-label="Search" style="width: 200px;">
                  </div>
                  <div class="mb-3" style="margin-left: 5px;">
                    <label for="nama" class="form-label">Sebagai</label>
                    <input type="text" name="search2" class="form-control me-2" type="search" placeholder="Search" aria-label="Search" style="width: 200px;">
                  </div>
                  <div class="mb-3" style="margin-left: 5px;">
                    <label for="nama" class="form-label">Nama</label>
                    <input type="text" name="search3"class="form-control me-2" type="search" placeholder="Search" aria-label="Search" style="width: 200px;">
                  </div>
                  <div class="mb-3" style="margin-left: 5px;">
                    <button class="btn btn-outline-success" type="submit" style="margin-top: 31px;">Cari</button>
                  </div>
        </form>
            ...
            <tbody>
              ...
              // Membuat query berdasarkan kondisi pencarian
                if (!empty($search1) && !empty($search2) && !empty($search3)) {
                  $sql = "SELECT * FROM user_pengaduan WHERE MONTH(tgl_pengaduan) LIKE '%$search1%' AND sebagai LIKE '%$search2%' nama LIKE '%$search3%'";
                } elseif (!empty($search1)) {
                  $sql = "SELECT * FROM user_pengaduan WHERE MONTH(tgl_pengaduan) LIKE '%$search1%'";
                } elseif (!empty($search2)) {
                  $sql = "SELECT * FROM user_pengaduan WHERE sebagai LIKE '%$search2%'";
                } elseif (!empty($search3)) {
                  $sql = "SELECT * FROM user_pengaduan WHERE nama LIKE '%$search3%'";
                } else {
                  $sql = "SELECT * FROM user_pengaduan";
                }
                $No=1;
